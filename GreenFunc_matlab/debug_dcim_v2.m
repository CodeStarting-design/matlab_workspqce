...
for cc = 1:size(configs,1)
    N1 = configs{cc,1}; N2 = configs{cc,2}; tol_svd = configs{cc,3};
    L1 = floor(N1/2); L2 = floor(N2/2);
    ...
    [at1, a1, ~] = GPOF(K1(:), t1(:), L1, tol_svd, 1e-16);
    ...
    [at2, a2, res2] = GPOF(K2m(:), t2(:), L2, tol_svd, 1e-16);
    ...
    fprintf('N1=%3d N2=%3d tol=%.0e | L2: %2d exp, res=%.2e | 镜像:%2d | 误差: %6.2f%%\n', ...
        N1, N2, tol_svd, length(at2), res2, length(aa), err);
end
